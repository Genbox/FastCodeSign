using System.Text;
using Genbox.FastCodeSignature.Native.MacCodeSign.Native.Enums;
using static Genbox.FastCodeSignature.Native.MacCodeSign.Native.MacNative;

namespace Genbox.FastCodeSignature.Native.MacCodeSign;
