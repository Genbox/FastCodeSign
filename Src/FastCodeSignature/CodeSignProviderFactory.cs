...
public static class CodeSignProviderFactory
{
    ...
    internal static CodeSignProvider CreateProvider(IAllocation allocation, IFormatHandler handler) => new CodeSignProvider(handler, allocation);
