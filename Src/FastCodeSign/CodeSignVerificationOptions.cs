...
{
    private readonly IReadOnlyList<string> _applicationPolicyOids = Array.AsReadOnly(new[] { "1.3.6.1.5.5.7.3.3" });
    private readonly IReadOnlyList<X509Certificate2> _customTrustRoots = Array.AsReadOnly(Array.Empty<X509Certificate2>());
